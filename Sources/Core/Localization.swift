...
enum S {
    ...
    private static let table: [String: (String, String)] = [
        ...
        "menu.usage": ("Usage anzeigen (lokal)", "Show usage (local)"),
        ...
        "mic.needs.ax": ("Chat geöffnet. Diktat braucht Bedienungshilfen (optional).", "Opened a chat. Dictation needs Accessibility (optional)."),
